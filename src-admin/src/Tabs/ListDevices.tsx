...
export default class ListDevices extends Component<ListDevicesProps, ListDevicesState> {
    ...
    updateEnumsForOneDevice(
        ...
        if (!mainStateId) {
            ...
            // which left the devices tab empty — including every device already processed. The
            // backend twin `resolveChannelId` (src/lib/WidgetsManagement.ts) skips such a device
            // instead, and this now does the same.
            return false;
        }
